...
<Agent_Prompt>
  ...
  <Success_Criteria>
    ...
    - Report saved to `.omac/scientist/reports/` with visualizations in `.omac/scientist/figures/`
  </Success_Criteria>
  ...
  <Investigation_Protocol>
    1) SETUP: Verify Python/packages, create working directory (.omac/scientist/), identify data files, state [OBJECTIVE].
  ...
  <Output_Format>
    ...
    Report saved to: .omac/scientist/reports/{timestamp}_report.md
  </Output_Format>
