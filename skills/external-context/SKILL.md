...
```
/oh-my-agent-connector:external-context <topic or question>
```

### Examples

```
/oh-my-agent-connector:external-context What are the best practices for JWT token rotation in Node.js?
/oh-my-agent-connector:external-context Compare Prisma vs Drizzle ORM for PostgreSQL
/oh-my-agent-connector:external-context Latest React Server Components patterns and conventions
```
...
```
Task(subagent_type="oh-my-agent-connector:document-specialist", model="sonnet", prompt="Search for: <facet 1 description>. Use WebSearch and WebFetch to find official documentation and examples. Cite all sources with URLs.")

Task(subagent_type="oh-my-agent-connector:document-specialist", model="sonnet", prompt="Search for: <facet 2 description>. Use WebSearch and WebFetch to find official documentation and examples. Cite all sources with URLs.")
```
