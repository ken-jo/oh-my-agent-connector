 ...
 * hook scripts, respecting the OMAC_STATE_DIR environment variable.
 *
 * Delegates to getOmacRoot() from dist/lib/worktree-paths.js (the canonical
 ...
 */
export async function resolveOmacStateRoot(directory) {
