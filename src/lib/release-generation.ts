...
const DEFAULT_REPO_URL = 'https://github.com/Yeachan-Heo/oh-my-agent-connector';
...
export function generateChangelog(
  ...
  let md = `# oh-my-agent-connector v${version}: ${title}\n\n`;
  md += `## Release Notes\n\n${summary}\n`;
...
export function generateReleaseBody(
  ...
  body += `\n### Install / Update\n\n`;
  body += '```bash\n';
  body += `npm install -g oh-my-agent-connector@${version}\n`;
  body += '```\n\n';
