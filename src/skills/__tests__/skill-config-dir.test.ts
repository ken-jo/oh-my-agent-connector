...
describe('skill markdown prose must not use raw ~/.claude (Contract 6, issue #2155 §16)', () => {
  ...
  const KNOWN_VIOLATION_BASELINE: Record<string, number> = {
    ...
    'skills/omac-doctor/SKILL.md': 7,
    'skills/omac-setup/SKILL.md': 5,
    'skills/omac-setup/phases/01-install-claude-md.md': 4,
    'skills/omac-setup/phases/02-configure.md': 3,
    'skills/omac-setup/phases/03-integrations.md': 3,
