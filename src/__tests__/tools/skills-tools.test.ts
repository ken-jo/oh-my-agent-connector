...
describe('skills-tools', () => {
  describe('loadLocalTool', () => {
    it('should have correct name and description', () => {
      expect(loadLocalTool.name).toBe('load_omac_skills_local');
  ...
  describe('loadGlobalTool', () => {
    it('should have correct name and description', () => {
      expect(loadGlobalTool.name).toBe('load_omac_skills_global');
  ...
  describe('listSkillsTool', () => {
    it('should have correct name and description', () => {
      expect(listSkillsTool.name).toBe('list_omac_skills');
