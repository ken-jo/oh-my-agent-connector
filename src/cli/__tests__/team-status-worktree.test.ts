...
describe('team CLI worktree status contract', () => {
  ...
  it('returns top-level and worker worktree metadata for JSON status callers', async () => {
    const worker = {
      ...
      assigned_tasks: ['1'],
      pane_id: '%1',
      working_dir: '/repo/.omac/team/demo-team/worktrees/worker-1',
      worktree_repo_root: '/repo',
      worktree_path: '/repo/.omac/team/demo-team/worktrees/worker-1',
      worktree_branch: 'omac-team/demo-team/worker-1',
      worktree_detached: false,
      worktree_created: true,
      team_state_root: '/repo/.omac/state/team/demo-team',
    };
