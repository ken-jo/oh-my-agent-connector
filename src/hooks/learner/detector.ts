...
Would you like me to extract this as a learned skill? Type \`/oh-my-agent-connector:skillify\` to save it (\`/oh-my-agent-connector:learner\` remains as a deprecated compatibility alias), or continue with your current task.
`.trim();
}
