 ...
 * (they have special handling elsewhere or are now skills with oh-my-agent-connector: prefix)
 */
export const EXCLUDED_COMMANDS = new Set([
  'ralph',
  'oh-my-agent-connector:ralplan',
  'oh-my-agent-connector:ultraqa',
  'oh-my-agent-connector:skillify',
  'oh-my-agent-connector:learner',
  'oh-my-agent-connector:plan',
